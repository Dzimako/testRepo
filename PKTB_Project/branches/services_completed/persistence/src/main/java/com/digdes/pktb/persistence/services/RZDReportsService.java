...
public interface RZDReportsService {
    ...
    DictionaryResponse getDictionary(UserBean userBean, String dictionaryUid, List<Pair> params);

    GetReportResponse getReport(UserBean userBean, Long reportName, List<Pair> params, String report_uid);
