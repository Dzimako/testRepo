            ...
            <td class="east" width="400px">
                ...
                <div id="allOrFavourites" class="tree-container ">
                    <ul>
                        ...
                        <li><a href="#favourites"><span class="ui-icon ui-icon-star"></span>Избранное</a></li>
                    </ul>
                    <div id="all" class="all">
                        <div class="reportsTreeExpandCollapse">
                            <a id="reportsTreeExpandCollapseExpand" href="#" class="reportsTreeExpandCollapseExpand">Раскрыть все</a>
                            |
                            <a id="reportsTreeExpandCollapseCollapse" href="#" class="reportsTreeExpandCollapseCollapse">Свернуть все</a>
                        </div>
