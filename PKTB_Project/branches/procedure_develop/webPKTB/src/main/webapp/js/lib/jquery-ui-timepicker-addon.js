		...
		*/
		_injectTimePicker: function() {
			...
			if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
				...
				this.hour_slider = $tp.find('.ui_tpicker_hour_slider').slider({//.prop('slide', null)
				...
				this.minute_slider = $tp.find('.ui_tpicker_minute_slider').slider({ //.prop('slide', null)
					orientation: "horizontal",
					value: this.minute,
					min: o.minuteMin,
					max: max.minute,
				...
				this.second_slider = $tp.find('.ui_tpicker_second_slider').slider({//.prop('slide', null)
					orientation: "horizontal",
					value: this.second,
					min: o.secondMin,
					max: max.second,
				...
				this.millisec_slider = $tp.find('.ui_tpicker_millisec_slider').slider({//.prop('slide', null)
					orientation: "horizontal",
					value: this.millisec,
					min: o.millisecMin,
					max: max.millisec,
