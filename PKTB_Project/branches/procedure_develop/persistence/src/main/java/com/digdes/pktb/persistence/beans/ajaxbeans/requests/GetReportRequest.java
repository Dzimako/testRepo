...
import com.digdes.pktb.persistence.beans.ajaxbeans.outputModel.ResultSetBean;
...
public class GetReportRequest {
    ...
    private List<ResultSetBean> resultSets;
    private ResultSetBean attributesResultSet;
    ...
    public List<ResultSetBean> getResultSets() {
        return resultSets;
    }

    public void setResultSets(List<ResultSetBean> resultSets) {
        this.resultSets = resultSets;
    }

    public ResultSetBean getAttributesResultSet() {
        return attributesResultSet;
    }

    public void setAttributesResultSet(ResultSetBean attributesResultSet) {
        this.attributesResultSet = attributesResultSet;
    }
